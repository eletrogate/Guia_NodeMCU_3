/*  ESP822 - NodeMCU Alarme Residencial IOT
    ...
    Blog Eletrogate:
    <blockquote class="wp-embedded-content" data-secret="MFvVkka3O8"><a href="https://blog.eletrogate.com/nodemcu-esp12-alarme-residencial-iot-3/">Guia completo do NodeMCU – ESP12 – Alarme Residencial  IOT  (3)</a></blockquote><iframe class="wp-embedded-content" sandbox="allow-scripts" security="restricted" style="position: absolute; clip: rect(1px, 1px, 1px, 1px);" title="“Guia completo do NodeMCU – ESP12 – Alarme Residencial  IOT  (3)” — Blog Eletrogate" src="https://blog.eletrogate.com/nodemcu-esp12-alarme-residencial-iot-3/embed/#?secret=MFvVkka3O8" data-secret="MFvVkka3O8" width="500" height="282" frameborder="0" marginwidth="0" marginheight="0" scrolling="no"></iframe>
...
char password[] = "12345";    // senha do roteador WIFI
